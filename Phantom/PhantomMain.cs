...
namespace Phantom
{
    public partial class PhantomMain : Form
    {
        ...
        private void Crypt()
        {
            ...
            // Add message to listBox2
            listBox2.Items.Add(@"Creating command file...");
            ...
            SaveFileDialog sfd = new SaveFileDialog()
            {
                ...
                DefaultExt = @"cmd",
                Title = @"Save File",
                Filter = @"Command File (*.cmd)|*.cmd",
                RestoreDirectory = true,
                FileName = Path.ChangeExtension(_input, @"cmd")
            };
        ...
        private void guna2Button3_Click(object sender, EventArgs e) => Crypt();
    }
}
